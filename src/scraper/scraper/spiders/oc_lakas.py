...
class OcLakasSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.oc.hu/ingatlanok/lista/jelleg:lakas;ertekesites:elado?page=1-50",
                  "https://www.oc.hu/ingatlanok/lista/jelleg:lakas;ertekesites:elado?page=51-100",
                  "https://www.oc.hu/ingatlanok/lista/jelleg:lakas;ertekesites:elado?page=101-150",
                  "https://www.oc.hu/ingatlanok/lista/jelleg:lakas;ertekesites:elado?page=151-200",
                  "https://www.oc.hu/ingatlanok/lista/jelleg:lakas;ertekesites:elado?page=201-250",
                  "https://www.oc.hu/ingatlanok/lista/jelleg:lakas;ertekesites:elado?page=251-300",
                  "https://www.oc.hu/ingatlanok/lista/jelleg:lakas;ertekesites:elado?page=301-350",
                  ]
    ...
    def parse_listing(self, response):
        ...
        if not is_new_apartment:
            ...
            stairwell_condition = response.xpath('//div[@class="col data-label" and text()="Lépcsőház állapota"]/following-sibling::div[@class="col data-value"][1]/text()').get(default="missing data")
